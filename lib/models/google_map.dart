...
List<GoogleMapResponse> googleMapResponseFromJson(String str) =>
    List<GoogleMapResponse>.from(
        json.decode(str).map((x) => GoogleMapResponse.fromJson(x)));

String googleMapResponseToJson(List<GoogleMapResponse> data) =>
...
class GoogleMapResponse {
  ...
  factory GoogleMapResponse.fromJson(Map<String, dynamic> json) =>
      GoogleMapResponse(
