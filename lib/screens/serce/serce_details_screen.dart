// ignore_for_file: prefer_interpolation_to_compose_strings, prefer_const_constructors, library_private_types_in_public_api, unnecessary_new, use_build_context_synchronously
...
class SerceDetailsScreen extends StatefulWidget {
  const SerceDetailsScreen({Key? key}) : super(key: key);
  static String routeName = '/serce_details_screen';

  @override
  _SerceDetailsScreenState createState() => _SerceDetailsScreenState();
}

class _SerceDetailsScreenState extends State<SerceDetailsScreen> {
      ...
      floatingActionButton: serce.seTurnOn == false
          ...
          : FloatingActionButton.extended(
              ...
              onPressed: () async {
                ...
                Navigator.pushNamed(context, MainContainer.routeName);
              },
            ),
