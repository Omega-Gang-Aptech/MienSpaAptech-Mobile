...
class SerceHistoryFinishScreen extends ConsumerStatefulWidget {
  const SerceHistoryFinishScreen({Key? key}) : super(key: key);
  static String routeName = '/serce_history_finish_screen';

  @override
  _SerceHistoryFinishScreenState createState() =>
      _SerceHistoryFinishScreenState();
}

class _SerceHistoryFinishScreenState
    extends ConsumerState<SerceHistoryFinishScreen> {
  @override
      ...
      data: (serceByUser) => serceByUser.isNotEmpty
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return serceByUser[index].orSerStatus.contains("Đã hoàn thành")
                    ? Padding(
