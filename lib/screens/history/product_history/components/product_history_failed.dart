...
class ProductHistoryFailed extends ConsumerStatefulWidget {
  const ProductHistoryFailed({Key? key}) : super(key: key);

  @override
  _ProductHistoryFailedState createState() => _ProductHistoryFailedState();
}

class _ProductHistoryFailedState extends ConsumerState<ProductHistoryFailed> {
      ...
      data: (order) => order.isNotEmpty
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    order[index].orProStatus.contains("Giao hàng thất bại")
                        ? Padding(
