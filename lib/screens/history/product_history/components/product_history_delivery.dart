...
class ProductHistoryDelivery extends ConsumerStatefulWidget {
  const ProductHistoryDelivery({Key? key}) : super(key: key);

  @override
  _ProductHistoryDeliveryState createState() => _ProductHistoryDeliveryState();
}

class _ProductHistoryDeliveryState
    extends ConsumerState<ProductHistoryDelivery> {
      ...
      data: (order) => order.isNotEmpty
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Column(
                  children: [
                    order[index].orProStatus.contains("Đang giao hàng")
                        ? Padding(
